        ...
        <div className={`loaderContainer ${hideLoader ? 'slideUp' : ''}`}>
            ...
            {showText && (
                <p className="creatorText">
                    Created by <a href="https://x.com/drkerco" target="_blank" rel="noopener noreferrer">DRKNESS</a> and <a href="https://x.com/ftk789yt" target="_blank" rel="noopener noreferrer">ftk789</a>
                </p>
            )}
        </div>
    );
